...
const SPACE_DIAL_CONFIG = {
  scene: {
    background: "#02040b",
    pixelWashOpacity: slider(0.52, 0, 1, 0.01),
    isometricY: slider(0.5, 0.2, 1, 0.01),
    motionSpeed: slider(1, 0, 5, 0.01),
  },
  camera: {
    fitPaddingX: slider(64, 0, 240, 1),
    fitPaddingY: slider(154, 0, 360, 1),
    fitScale: slider(0.94, 0.5, 1.2, 0.01),
  },
  starfield: {
    opacity: slider(1, 0, 2, 0.01),
    twinkle: slider(1, 0, 3, 0.01),
    farAlpha: slider(0.42, 0, 1, 0.01),
    midAlpha: slider(0.66, 0, 1, 0.01),
    nearAlpha: slider(0.92, 0, 1, 0.01),
    warm: "#edc99c",
    cool: "#9bc9e8",
    white: "#dce4ef",
  },
  orbits: {
    color: "#5f82a6",
    opacity: slider(0.18, 0, 1, 0.01),
    dash: slider(8, 0, 24, 1),
    moonColor: "#96b7d7",
    moonOpacity: slider(0.24, 0, 1, 0.01),
    moonDash: slider(5, 0, 20, 1),
  },
  asteroids: {
    count: slider(210, 0, 800, 1),
    radius: slider(380, 120, 900, 1),
    spread: slider(54, 0, 240, 1),
    opacity: slider(1, 0, 2, 0.01),
    speed: slider(1, 0, 4, 0.01),
    warm: "#a18b72",
    cool: "#655f62",
  },
  glow: {
    sun: slider(1, 0, 3, 0.01),
    earth: slider(1, 0, 3, 0.01),
    moon: slider(1, 0, 3, 0.01),
    motes: slider(28, 0, 80, 1),
    sunCore: "#ffd15b",
    sunMid: "#ff8723",
    sunEdge: "#ff5814",
    moteHot: "#ffcf58",
  ...
  labels: {
    fontSize: slider(8, 6, 18, 1),
    letterSpacing: slider(0.11, 0, 0.3, 0.01),
    offset: slider(31, 8, 72, 1),
    fill: "#b9c8ca",
    activeFill: "#e2eff0",
  },
  navigator: {
    buttonSize: slider(42, 32, 72, 1),
  ...
  card: {
    width: slider(326, 200, 520, 1),
    titleSize: slider(17, 12, 32, 1),
    bodySize: slider(13, 10, 22, 1),
    fill: "#03090f",
    fillOpacity: slider(0.91, 0, 1, 0.01),
  },
  ui: {
    ink: "#dce8ed",
    muted: "#71838d",
    line: "#6f97a6",
    lineOpacity: slider(0.28, 0, 1, 0.01),
  },
