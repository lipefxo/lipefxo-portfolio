...
const SPACE_DIAL_CONFIG = {
  ...
  cursorLens: {
    radius: slider(150, 80, 280, 1),
    strength: slider(4, 0, 12, 0.25),
    followLag: slider(0.08, 0, 0.24, 0.005),
    fadeDuration: slider(0.16, 0.05, 0.4, 0.01),
  },
  events: {
  ...
  planets: {
    _collapsed: true,
    sun: {
      scale: slider(1, 0.4, 2.2, 0.01),
      minSize: slider(46, 8, 120, 1),
    },
    mercury: {
      scale: slider(1, 0.4, 2.2, 0.01),
      minSize: slider(9, 4, 40, 1),
