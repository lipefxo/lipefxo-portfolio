  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 w-full max-w-lg rounded-lg border border-zinc-200 bg-white p-6 shadow-xl sm:p-8 dark:border-zinc-800 dark:bg-zinc-950">
        <button
          ref={closeRef}
          type="button"
          onClick={onClose}
        ...
        <h3
          ...
          className="pr-8 text-2xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50"
        >
          {project.title}
        </h3>
        ...
        {project.tech && project.tech.length > 0 && (
          <ul className="mt-5 flex flex-wrap gap-2">
            {project.tech.map((t) => (
              <li
                key={t}
                className="rounded-md border border-zinc-200 px-3 py-1 text-xs text-zinc-600 dark:border-zinc-800 dark:text-zinc-400"
              >
                {t}
              </li>
            ))}
